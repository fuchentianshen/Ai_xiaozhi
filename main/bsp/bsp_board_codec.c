...
// 初始化I2C接口
void bsp_board_codec_i2c_init(bsp_board_t *board,
...
// 初始化i2s接口
void bsp_board_codec_i2s_init(bsp_board_t *board,
                              ...
                              i2s_chan_handle_t *tx_handle)
{
    ...
    i2s_std_config_t std_cfg = {
        ...
        .slot_cfg = I2S_STD_PHILIPS_SLOT_DEFAULT_CONFIG(CODEC_BIT_WIDTH, I2S_SLOT_MODE_MONO),
        .gpio_cfg = {
            .mclk = CODEC_MCK_PIN,
            .bclk = CODEC_BCK_PIN,
            .ws = CODEC_WS_PIN,
